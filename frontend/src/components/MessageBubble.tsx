              ...
              {showSources && (
                <div className="mt-2 grid gap-2">
                  {message.sources.map((src, i) => (
                    <div
                      key={i}
                      className="bg-slate-50 border border-slate-200 rounded-lg p-3 text-xs text-slate-600"
                    >
                      ...
                      {src.speaker && (
                        <div className="text-slate-500 mb-1">
                          Speaker: {src.speaker} | Date: {src.date}
                        </div>
                      )}
                      <div className="text-slate-600 italic border-l-2 border-slate-300 pl-2">
                        "{src.preview}"
                      </div>
                    </div>
                  ))}
